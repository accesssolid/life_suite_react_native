    ...
    let config = {
      ...
      endPoint:
        user.user_role == role.customer
          ? '/api/customerFcmUpdate'
          : '/api/providerFcmUpdate',
      type: 'post',
    };
    getApi(config)
      .then(response => {
      ...
      try {
        const granted = await PermissionsAndroid.request(
          PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION,
          {
            ...
            message: 'Lifesuite needs to access your location ',
        ...
        {user.user_role == 3 && (
          <TouchableOpacity
            style={{
              ...
              marginTop: 25,
              marginBottom: 15,
              backgroundColor: isAddJobActive
                ? 'rgba(0,0,0,0.2)'
                : LS_COLORS.global.white,
