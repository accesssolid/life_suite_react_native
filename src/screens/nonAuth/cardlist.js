      ...
      <SafeAreaView style={{flex: 1, backgroundColor: LS_COLORS.global.cyan}}>
        ...
        <View style={{flex: 1, backgroundColor: 'white'}}>
          <FlatList
            ...
            data={cards}
            ListHeaderComponent={
              loader && <ActivityIndicator color={LS_COLORS.global.green} />
            }
            ListEmptyComponent={
              <View
                style={[
                ...
                <Text
                  ...
                  style={[styles.saveText, {color: 'gray'}]}>
                  No Cards
                </Text>
              </View>
            }
            renderItem={({item}) => {
              return (
                <TouchableOpacity
                  activeOpacity={0.5}
                  key={item.id}
                  style={{minHeight: 200, marginTop: 20, position: 'relative'}}
                  onPress={() => {
                  ...
                  <ImageBackground
                      ...
                      <View
                        ...
                        <Pressable
                         onPress={() => {
                            Alert.alert(
                              'Message',
                              'Do you want to make this card as primary card?',
                              [
                                {
                                  text: 'No',
                                },
                    ...
                    <View
                      ...
                      <View>
                        <Text
                          maxFontSizeMultiplier={1.5}
                          style={[styles.saveText, {color: 'black'}]}>
                          Expiry Date
                        </Text>
                        <Text
                          maxFontSizeMultiplier={1.5}
